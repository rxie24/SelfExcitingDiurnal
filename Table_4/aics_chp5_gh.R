...
#CHP_ESTS_0
ll_ids1 <- readRDS(paste0(wdest,"CHP_ID_LLs0.rds"))
all_ids <- seq(1,41,1)
no_ids <- c(1, 6, 7, 8, 10, 13, 14, 24, 26, 28, 30, 34, 40, 41)
id_ind1 <- setdiff(all_ids,no_ids)
...
#CHP_ESTS_1
ll_ids2 <- readRDS(paste0(wdest,"CHP_ID_LLs1.rds"))
id_ind2 <- c(1, 6, 7, 8, 10, 24, 28, 30, 40)
...
#CHP_ESTS_2
ll_ids3 <- readRDS(paste0(wdest,"CHP_ID_LLs2.rds"))
id_ind3 <- c(13, 14, 26, 41)
...
#CHP_ESTS_3
ll_ids3 <- readRDS(paste0(wdest,"CHP_ID_LLs3.rds"))
id_ind3 <- 34
all_lls[id_ind3,1] <- as.numeric(ll_ids3[2])
all_lls[id_ind3,2] <- as.numeric(ll_ids3[3])
all_lls[id_ind3,3] <- as.numeric(ll_ids3[4])
